...
class MiddlewareBenchmark {
    private lateinit var baseHandler: RawHandler
    private lateinit var handlerWith1Middleware: RawHandler
    private lateinit var handlerWith3Middlewares: RawHandler
    private lateinit var handlerWith5Middlewares: RawHandler
    private lateinit var handlerWith10Middlewares: RawHandler
    private lateinit var testRequest: Request

    @Setup
    fun setup() {
        baseHandler = { _ ->
            Response(status = HttpStatus.OK, body = Body.Strict("ok".toByteArray()))
        }
